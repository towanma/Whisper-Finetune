...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_input", type=str, default="dataset/train.jsonl", help="Input training data JSON file.")
    parser.add_argument("--train_output", type=str, default="dataset/train_filtered.jsonl", help="Output filtered training data JSON file.")
    parser.add_argument("--test_input", type=str, default="dataset/test.jsonl", help="Input test data JSON file.")
    parser.add_argument("--test_output", type=str, default="dataset/test_filtered.jsonl", help="Output filtered test data JSON file.")
